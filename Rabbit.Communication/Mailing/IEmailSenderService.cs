...
namespace Rabbit.Communication.Mailing
{
    public interface IEmailSenderService
    {
        ...
        void Send(string from, string to, IMailMessageTransformer msgTransformer, object model = null);
        ...
        void Send(KeyValuePair<string, string> from, KeyValuePair<string, string> to, IMailMessageTransformer msgTransformer, object model = null);
